/*
 * Vilda Dependencies Helper v1.18.0
 *
...
(function (global) {
  ...
  function registerDefaultContracts() {
    ...
    defineModuleDeps('estimated-intake-card-helpers', [
      ...
      description: '8O-9b/8O-9f: neutralne helpery, kolektor alert-probe i czysty model obliczeniowy estimated intake wydzielone do vilda_estimated_intake.js; app.js zachowuje wrappery, render, commit window.* i alert decision',
      pages: ['index.html'],
      script: 'app.js',
    ...
    defineModuleDeps('estimated-intake-alert-probe-audit', [
      ...
      { path: 'energyBuildIntakeObservedState', type: 'function', source: 'app.js energy model', script: 'app.js' },
      { path: 'energyIsNumeric', type: 'function', source: 'app.js energy model', script: 'app.js' },
    ...
    defineModuleDeps('estimated-intake-calc-seam', [
      ...
      { path: 'buildEstimatedIntakeCalcInputModel', type: 'function', source: 'app.js calc seam', script: 'app.js' },
      { path: 'buildEstimatedIntakeLastObservedModel', type: 'function', source: 'app.js calc seam', script: 'app.js' },
      ...
      { path: 'buildEstimatedIntakeHistoryForRisk', type: 'function', source: 'app.js calc seam', script: 'app.js' },
      ...
      description: '8O-9e/8O-9f: seam wejścia/wyjścia calcEstimatedIntake() z delegowanym czystym modelem obliczeniowym; read-only snapshot bez renderowania DOM i bez zapisu window.*',
      pages: ['index.html'],
      script: 'app.js',
      loadAfter: ['vilda_deps.js', 'vilda_estimated_intake.js', 'app.js']
    });
    ...
    defineModuleDeps('estimated-intake-calculation-model', [
      ...
      description: '8O-9f: czysty model obliczeniowy estimated intake jest delegowany do VildaEstimatedIntake; app.js nadal renderuje DOM, commituję window.intakeHistory/window.intakeEstimatedKcalPerDay i wykonuje post-render risk checks',
      pages: ['index.html'],
      script: 'vilda_estimated_intake.js/app.js',
      loadAfter: ['vilda_deps.js', 'vilda_estimated_intake.js', 'app.js']
    });
    ...
    defineModuleDeps('update-hooks-nutrition-micros-wrapper', [
      ...
      description: '8O-10d-g: wrapper window.update z nutrition_micros.js został przepięty na VildaUpdateHooks jako hook renderowania karty mikroelementów, wykonywany po hooku nutrition_norms.js; bez zmiany obliczeń mikroelementów',
      pages: ['index.html'],
    ...
    defineModuleDeps('gh-therapy-indexeddb-resource-audit', [
      ...
      description: '8O-11j: read-only audyt stanu po domknięciu IDBDatabase, onversionchange, lifecycle cleanup BroadcastChannel, lifecycle/scope cleanup MutationObserver, fetch timeout cleanup, audycie strategii Service Workera, smoke E2E offline/update-flow, naprawie cache key wersjonowanych zasobów shell, runtime cache pruning i client-side lifecycle rejestracji/update-flow SW; bez otwierania bazy, bez wysyłania komunikatów, bez pobierania zasobów przez audyt, bez dotykania cache i bez zmian danych',
      pages: ['index.html', 'docpro.html', 'kalkulator-klirens.html'],
