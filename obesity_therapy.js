...
(function () {
  ...
  function init() {
    ...
    // `vildaSetInterval` (wrapper z custom-fixes.js) automatycznie kasuje
    // aktywne intervale przy nawigacji Turbo, żeby nie tykały dalej po
    // przejściu na inną podstronę.
    ...
    _setInt(syncVisibilityWithDoctorModule, 1000);
