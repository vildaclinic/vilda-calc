(function(window, document) {
  ...
  // MICRONORMS_EMBEDDED_FALLBACK wydzielone do data/micronorms-fallback.js (Faza 4/15).
  // Plik ładuje się defer PRZED tym skryptem, więc window.VildaMicronormsFallback istnieje.
  // Fallback w razie braku ładowania (np. CSP zablokowane) — pusty obiekt nie spowoduje crash,
  // bo właściwe dane i tak są pobierane przez fetch z /micronorms_*.json.
  const MICRONORMS_EMBEDDED_FALLBACK = (window.VildaMicronormsFallback) || {};
