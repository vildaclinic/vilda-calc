 ...
 */
const WFL_DATA_GIRLS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.WFL_DATA_GIRLS) ? window.VildaLMS.WFL_DATA_GIRLS : {};
...
const WFL_DATA_BOYS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.WFL_DATA_BOYS) ? window.VildaLMS.WFL_DATA_BOYS : {};
...
const LMS_BOYS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_BOYS) ? window.VildaLMS.LMS_BOYS : {};
const LMS_GIRLS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_GIRLS) ? window.VildaLMS.LMS_GIRLS : {};

/* === OLAF BMI‑for‑age 3‑18 l. – L, M, S ============================ */
const OLAF_LMS_BOYS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.OLAF_LMS_BOYS) ? window.VildaLMS.OLAF_LMS_BOYS : {};

const OLAF_LMS_GIRLS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.OLAF_LMS_GIRLS) ? window.VildaLMS.OLAF_LMS_GIRLS : {};

// LMS WHO – masa ciała dla wieku 0–36 mies. (chłopcy i dziewczynki)  
const LMS_INFANT_WEIGHT_BOYS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_INFANT_WEIGHT_BOYS) ? window.VildaLMS.LMS_INFANT_WEIGHT_BOYS : {};  

const LMS_INFANT_WEIGHT_GIRLS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_INFANT_WEIGHT_GIRLS) ? window.VildaLMS.LMS_INFANT_WEIGHT_GIRLS : {};  

// LMS WHO – długość/wzrost dla wieku 0–36 mies. (chłopcy i dziewczynki)  
const LMS_INFANT_HEIGHT_BOYS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_INFANT_HEIGHT_BOYS) ? window.VildaLMS.LMS_INFANT_HEIGHT_BOYS : {};  

const LMS_INFANT_HEIGHT_GIRLS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_INFANT_HEIGHT_GIRLS) ? window.VildaLMS.LMS_INFANT_HEIGHT_GIRLS : {};  

// Wzrost-for-age (Height-for-age) – WHO LMS data, chłopcy 36–216 miesięcy
const LMS_HEIGHT_WHO_BOYS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_HEIGHT_WHO_BOYS) ? window.VildaLMS.LMS_HEIGHT_WHO_BOYS : {};

// Wzrost-for-age – WHO LMS data, dziewczynki 36–216 miesięcy
const LMS_HEIGHT_WHO_GIRLS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_HEIGHT_WHO_GIRLS) ? window.VildaLMS.LMS_HEIGHT_WHO_GIRLS : {};

// Masa ciała-for-age (Weight-for-age) – WHO LMS data, chłopcy 36–120 miesięcy
const LMS_WEIGHT_WHO_BOYS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_WEIGHT_WHO_BOYS) ? window.VildaLMS.LMS_WEIGHT_WHO_BOYS : {};

// Masa ciała-for-age – WHO LMS data, dziewczynki 36–120 miesięcy
const LMS_WEIGHT_WHO_GIRLS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_WEIGHT_WHO_GIRLS) ? window.VildaLMS.LMS_WEIGHT_WHO_GIRLS : {};
/* =================================================================== */
// LMS dla wagi chłopców 3–18 lat (klucz: wiek w miesiącach, wartość: [L, M, S])
const LMS_WEIGHT_BOYS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_WEIGHT_BOYS) ? window.VildaLMS.LMS_WEIGHT_BOYS : {};
// LMS dla wzrostu chłopców 3–18 lat
const LMS_HEIGHT_BOYS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_HEIGHT_BOYS) ? window.VildaLMS.LMS_HEIGHT_BOYS : {};
// LMS dla wagi dziewczynek 3–18 lat
const LMS_WEIGHT_GIRLS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_WEIGHT_GIRLS) ? window.VildaLMS.LMS_WEIGHT_GIRLS : {};
// LMS dla wzrostu dziewczynek 3–18 lat
const LMS_HEIGHT_GIRLS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_HEIGHT_GIRLS) ? window.VildaLMS.LMS_HEIGHT_GIRLS : {};
...
const LMS_INFANT_BOYS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_INFANT_BOYS) ? window.VildaLMS.LMS_INFANT_BOYS : {};
const LMS_INFANT_GIRLS = (typeof window !== 'undefined' && window.VildaLMS && window.VildaLMS.LMS_INFANT_GIRLS) ? window.VildaLMS.LMS_INFANT_GIRLS : {};
