/*
 * Vilda GH Therapy Resource Audit v1.12.0
 *
 * Krok 8O-11k: read-only audyt miejsc użycia IndexedDB, BroadcastChannel,
 ...
 * wdrożonego TTL/max-entry pruning runtime cache client-side lifecycle rejestracji/update-flow Service Workera oraz smoke UX banera aktualizacji Service Workera.
...
(function (global) {
  ...
  const SERVICE_WORKER_VERSION = '0.9.406';
