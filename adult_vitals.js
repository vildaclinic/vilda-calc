(function(window, document) {
  ...
  function adultVitalsSetTrustedHtml(element, markup, context) {
    ...
    try {
      if (typeof window !== 'undefined' && window.VildaHtml && typeof window.VildaHtml.setTrustedHtml === 'function') {
        return window.VildaHtml.setTrustedHtml(element, html, { context: context || 'adultVitals' });
      }
      element.textContent = html;
      return true;
    } catch (_) {
      if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
        globalThis.vildaLogSwallowedCatch('adult_vitals.js', _, { helper: 'adultVitalsSetTrustedHtml', context: context || '' });
      }
      return false;
    }
  }

  function adultVitalsClearHtml(element) {
    if (!element) return false;
    try {
      ...
      if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
        globalThis.vildaLogSwallowedCatch('adult_vitals.js', _, { helper: 'adultVitalsClearHtml' });
      }
      return false;
    }
  }
  ...
  function clearHomePulse(node) {
    ...
    if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
      globalThis.vildaLogSwallowedCatch('adult_vitals.js', _, { line: 92 });
    }
  }
  ...
  function applyHomePulse(node, level) {
    ...
    if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
      globalThis.vildaLogSwallowedCatch('adult_vitals.js', _, { line: 103 });
    }
  }
  ...
  function refreshVisibility() {
    ...
    clearHomePulse(resultBox);
    if (!isAdult) {
      adultVitalsClearHtml(resultBox);
    } else {
      const state = getState();
      adultVitalsSetTrustedHtml(resultBox, buildHomeResultHtml(state), 'adult-vitals:result');
    ...
    if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
      globalThis.vildaLogSwallowedCatch('adult_vitals.js', _, { line: 767 });
    }
  }
  }
  ...
  if (typeof window !== 'undefined' && typeof window.vildaOnReady === 'function') {
    window.vildaOnReady('adult-vitals:init', init);
