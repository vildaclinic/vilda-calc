...
//  3. (do raty G) rozpisanie bylo osobne dla kazdego rejestru; od P-DIETA-REJESTR rata G (2026-09-21)
//     jest jeden rejestr (standardowy) i jedna lista punktow na klucz;
...
test('punkty cytuja zdania: dorosli i dzieci', async ({ page }) => {
...
// (test „rozpisanie jest osobne dla kazdego rejestru" usuniety w P-DIETA-REJESTR rata G: zostal jeden rejestr)
