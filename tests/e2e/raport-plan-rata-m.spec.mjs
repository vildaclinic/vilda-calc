...
test('zdania planu: bez zdania o diecie/PAL, pozycje małą literą, ruch „dojdziesz do celu o … wcześniej”', async ({ page }) => {
  ...
  expect(a.tekst).toMatch(/Twój zadeklarowany plan: dieta [a-ząćęłńóśźż]+ i spacer 30 min\/d — razem ok\. [\d\s\u00A0\u202F]+ kcal tygodniowo\. Tempo pokazane powyżej dotyczy samej diety; z ruchem to ok\. −\d,\d\u202Fkg tygodniowo\. Dzięki ruchowi dojdziesz do celu (o [^.]+ |nieco )wcześniej niż na samej diecie\./u);
