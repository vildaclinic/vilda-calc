...
describe('Klirens — centralny model przepływu UI', () => {
  ...
  it('wersjonuje i dodaje nowy workflow do powłoki PWA', () => {
    ...
    expect(html).toContain('clcr_ui_workflow.css?v=3');
