...
if (typeof workbox !== 'undefined') {
  ...
  workbox.core.setCacheNameDetails({ prefix: 'pwa-klirens' });
  ...
  workbox.precaching.precacheAndRoute([
    ...
    // latest version from the network and update the cache.
    { url: 'Kalkulator_klirens.html', revision: 'ef371b296c986e9312c400abcafdeded' },
    { url: 'manifest.json',      revision: 'a1cf78277f728670de6db80203e02ee8' },
