...
// dosing.
// GLOBAL_MAX_DAILY_DOSES wydzielone do data/antibiotic-tables.js (Faza 4/16). Plik ładuje się defer PRZED tym skryptem.
const GLOBAL_MAX_DAILY_DOSES = (window.VildaAntibioticTables && window.VildaAntibioticTables.GLOBAL_MAX_DAILY_DOSES) || {};
 ...
 */
// LYME_SCHEMES wydzielone do data/antibiotic-tables.js (Faza 4/16). Plik ładuje się defer PRZED tym skryptem.
const LYME_SCHEMES = (window.VildaAntibioticTables && window.VildaAntibioticTables.LYME_SCHEMES) || {};
...
// CITATION_MAP wydzielone do data/antibiotic-tables.js (Faza 4/16). Plik ładuje się defer PRZED tym skryptem.
const CITATION_MAP = (window.VildaAntibioticTables && window.VildaAntibioticTables.CITATION_MAP) || {};
...
// ABX_INDICATIONS wydzielone do data/antibiotic-tables.js (Faza 4/16). Plik ładuje się defer PRZED tym skryptem.
const ABX_INDICATIONS = (window.VildaAntibioticTables && window.VildaAntibioticTables.ABX_INDICATIONS) || {};
