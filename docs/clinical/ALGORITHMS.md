...
Pozostałe ustalenia przeglądu do kolejnych etapów: (S2) niedowaga dorosłych bez żadnego komunikatu; „redukcja 0,1 kg" przy BMI 24,9–25 u dorosłych (kolizja celu 24,9 z progiem normy < 25 i martwy komunikat o zbliżaniu do granicy); mylące „Do 50 centyla BMI brakuje X kg" (to nadwyżka, nie brak) wstrzykiwane też do boxa „BMI w normie"; (S3, decyzje) brak czynnika dziecięcego +10% w tabeli aktywności (stosuje go karta „Kalorie posiłków"), czas/dystans przy stałej masie startowej, etykieta „Otyłość olbrzymia" u niemowląt.
