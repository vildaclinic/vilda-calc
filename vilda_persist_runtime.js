...
if (hasIntakeModule) {
  ...
  function resetLoadedComparisonUiResidue() {
    ...
    // FIX regresu (2026-06-03): reset („Wyczyść wszystkie pola"/twardy reset)
    // chowa kartę „Ostatni pomiar" stylami bezpośrednio, więc musi też usunąć
    // klucz reload-survival (vilda_summary_cards) — inaczej karta wracała po
    // przeładowaniu mimo wyczyszczenia aplikacji.
