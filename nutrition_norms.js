(function(window, document) {
  ...
  const NUTRITION_NORMS_MODULE_VERSION = '1.1.2';
  ...
  function nutritionNormsSetTrustedHtml(element, markup, context) {
    if (!element) return false;
    const html = markup == null ? '' : String(markup);
    try {
      if (window.VildaHtml && typeof window.VildaHtml.setTrustedHtml === 'function') {
        return window.VildaHtml.setTrustedHtml(element, html, { context: context || 'nutrition-norms' });
      }
      element.textContent = html;
      return true;
    } catch (_) {
      if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
        globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { helper: 'setTrustedHtml', context: context || '' });
      }
      return false;
    }
  }

  function nutritionNormsClearHtml(element) {
    if (!element) return false;
    try {
      ...
      if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
        globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { helper: 'clearHtml' });
      }
      return false;
    }
  }

  function nutritionNormsHasHtmlContent(element) {
    if (!element) return false;
    try {
      ...
      if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
        globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { helper: 'hasHtmlContent' });
      }
      return false;
    }
  }
  ...
  function nutritionNormsEnsurePracticeSheet() {
    ...
    root.hidden = true;
    nutritionNormsSetTrustedHtml(root, `
      ...
      </div>`, 'nutrition-norms:practice-sheet-shell');
  ...
  function nutritionNormsOpenPracticeSheet(type) {
    ...
    if (bodyEl) {
      nutritionNormsSetTrustedHtml(bodyEl, sheetModel.bodyHtml || '', 'nutrition-norms:practice-sheet-body');
      bodyEl.scrollTop = 0;
    }
  ...
  function nutritionNormsSaveCardOpen(open) {
    ...
    if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
      globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { line: 2122 });
    }
  }
  }
  ...
  function bindNutritionNormsToggle() {
    ...
    if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
      globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { line: 2156 });
    }
  }

      const nextOpen = !currentlyOpen;
      nutritionNormsSaveCardOpen(nextOpen);
      if (nextOpen && (!window.nutritionNormsLastModel || !mount || !nutritionNormsHasHtmlContent(mount))) {
        try { renderNutritionNormsCardFromDom(); } catch (_) {
    if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
      globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { line: 2163 });
    }
  }
      }
      nutritionNormsApplyVisibility(!!window.nutritionNormsLastModel || !!(mount && nutritionNormsHasHtmlContent(mount)));
    });
  ...
  function clearNutritionNormsCard() {
    const mount = el('nutritionNormsMount');
    if (mount) nutritionNormsClearHtml(mount);
  ...
  function renderNutritionNormsCardFromDom() {
    ...
    nutritionNormsSetTrustedHtml(mount, nutritionNormsRenderCard(model), 'nutrition-norms:card');
    ...
    if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
      globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { line: 2214 });
    }
  }
    try {
    ...
    if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
      globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { line: 2221 });
    }
  }
    return model;
  }
  ...
  function initNutritionNormsCardInteractions() {
    ...
    if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
      globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { line: 2239 });
    }
  }
        return;
      }
  ...
  function ensureNutritionNormsCardShell() {
    ...
    if (!el('nutritionNormsMount')) {
      nutritionNormsSetTrustedHtml(card, `
        <h2 style="text-align:center;">Normy żywieniowe: białko, tłuszcz, węglowodany</h2>
        <div id="nutritionNormsMount"></div>`, 'nutrition-norms:card-shell');
    }
  ...
  const NUTRITION_NORMS_AFTER_UPDATE_COALESCE_STEP = '8P-10';
  let nutritionNormsAfterUpdateHookRegistered = false;
  let nutritionNormsAfterUpdateHookToken = null;
  let nutritionNormsAfterUpdateFrameId = null;
  let nutritionNormsAfterUpdatePendingContext = null;
  let nutritionNormsAfterUpdateScheduledCount = 0;
  let nutritionNormsAfterUpdateCoalescedCount = 0;
  let nutritionNormsAfterUpdateRenderRuns = 0;
  let nutritionNormsAfterUpdateLastResult = null;

  function getNutritionNormsAfterUpdateRafScheduler() {
    ...
    return function scheduleWithTimeout(callback) {
      return setTimeout(function runNutritionNormsAfterUpdateFallbackFrame() { callback((typeof Date !== 'undefined' && Date.now) ? Date.now() : 0); }, 0);
    };
  }

  function runNutritionNormsAfterUpdateRender(context) {
    try {
      renderNutritionNormsCardFromDom();
      nutritionNormsAfterUpdateRenderRuns += 1;
      nutritionNormsAfterUpdateLastResult = { skipped: false, rendered: true, scheduled: false, step: NUTRITION_NORMS_AFTER_UPDATE_COALESCE_STEP };
      return nutritionNormsAfterUpdateLastResult;
    } catch (_) {
      if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
        globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { step: NUTRITION_NORMS_AFTER_UPDATE_COALESCE_STEP, hook: NUTRITION_NORMS_AFTER_UPDATE_HOOK_ID });
      }
      nutritionNormsAfterUpdateLastResult = { skipped: false, rendered: false, scheduled: false, step: NUTRITION_NORMS_AFTER_UPDATE_COALESCE_STEP, error: String(_ && _.message ? _.message : _) };
      return nutritionNormsAfterUpdateLastResult;
    }
  }

  function scheduleNutritionNormsAfterUpdateRender(context) {
    nutritionNormsAfterUpdateScheduledCount += 1;
    nutritionNormsAfterUpdatePendingContext = context || null;
    if (nutritionNormsAfterUpdateFrameId !== null) {
      nutritionNormsAfterUpdateCoalescedCount += 1;
      return { skipped: false, rendered: false, scheduled: true, coalesced: true, step: NUTRITION_NORMS_AFTER_UPDATE_COALESCE_STEP };
    }
    const schedule = getNutritionNormsAfterUpdateRafScheduler();
    nutritionNormsAfterUpdateFrameId = schedule(function runCoalescedNutritionNormsAfterUpdate() {
      const pendingContext = nutritionNormsAfterUpdatePendingContext;
      nutritionNormsAfterUpdateFrameId = null;
      nutritionNormsAfterUpdatePendingContext = null;
      runNutritionNormsAfterUpdateRender(pendingContext);
    });
    return { skipped: false, rendered: false, scheduled: true, coalesced: false, step: NUTRITION_NORMS_AFTER_UPDATE_COALESCE_STEP };
  }

  function getNutritionNormsAfterUpdateCoalescingSnapshot() {
    return {
      kind: 'vilda-nutrition-norms-after-update-coalescing-snapshot',
      step: NUTRITION_NORMS_AFTER_UPDATE_COALESCE_STEP,
      readOnly: true,
      didCallWindowUpdate: false,
      didRenderDom: false,
      hookId: NUTRITION_NORMS_AFTER_UPDATE_HOOK_ID,
      ...
      pending: nutritionNormsAfterUpdateFrameId !== null,
      scheduledCount: nutritionNormsAfterUpdateScheduledCount,
      coalescedCount: nutritionNormsAfterUpdateCoalescedCount,
      renderRuns: nutritionNormsAfterUpdateRenderRuns,
      lastResult: nutritionNormsAfterUpdateLastResult ? Object.assign({}, nutritionNormsAfterUpdateLastResult) : null
    };
  }
  ...
  function renderNutritionNormsAfterUpdate(context) {
    ...
    return scheduleNutritionNormsAfterUpdateRender(context);
  }

  const NUTRITION_NORMS_DIRECT_RENDER_COALESCE_STEP = '8P-11';
  let nutritionNormsDirectRenderFrameId = null;
  let nutritionNormsDirectRenderPendingSource = null;
  let nutritionNormsDirectRenderScheduledCount = 0;
  let nutritionNormsDirectRenderCoalescedCount = 0;
  let nutritionNormsDirectRenderRenderRuns = 0;
  let nutritionNormsDirectRenderSkippedCount = 0;
  let nutritionNormsDirectRenderLastResult = null;

  function getNutritionNormsDirectRenderRafScheduler() {
    if (typeof window !== 'undefined' && typeof window.requestAnimationFrame === 'function') {
      return function scheduleNutritionNormsDirectRenderWithRaf(callback) { return window.requestAnimationFrame(callback); };
    }
    if (typeof requestAnimationFrame === 'function') {
      return function scheduleNutritionNormsDirectRenderWithGlobalRaf(callback) { return requestAnimationFrame(callback); };
    }
    return function scheduleNutritionNormsDirectRenderWithTimeout(callback) {
      return setTimeout(function runNutritionNormsDirectRenderFallbackFrame() { callback((typeof Date !== 'undefined' && Date.now) ? Date.now() : 0); }, 0);
    };
  }

  function runNutritionNormsDirectRender(source) {
    const eventSource = source ? String(source) : 'direct-ui-event';
    if (!window.nutritionNormsLastModel) {
      nutritionNormsDirectRenderSkippedCount += 1;
      nutritionNormsDirectRenderLastResult = { skipped: true, reason: 'no-last-model', rendered: false, scheduled: false, source: eventSource, step: NUTRITION_NORMS_DIRECT_RENDER_COALESCE_STEP };
      return nutritionNormsDirectRenderLastResult;
    }
    try {
      renderNutritionNormsCardFromDom();
      nutritionNormsDirectRenderRenderRuns += 1;
      nutritionNormsDirectRenderLastResult = { skipped: false, rendered: true, scheduled: false, source: eventSource, step: NUTRITION_NORMS_DIRECT_RENDER_COALESCE_STEP };
      return nutritionNormsDirectRenderLastResult;
    } catch (_) {
      if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
        globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { step: NUTRITION_NORMS_DIRECT_RENDER_COALESCE_STEP, source: eventSource });
      }
      nutritionNormsDirectRenderLastResult = { skipped: false, rendered: false, scheduled: false, source: eventSource, step: NUTRITION_NORMS_DIRECT_RENDER_COALESCE_STEP, error: String(_ && _.message ? _.message : _) };
      return nutritionNormsDirectRenderLastResult;
    }
  }

  function scheduleNutritionNormsDirectRender(source) {
    const eventSource = source ? String(source) : 'direct-ui-event';
    if (!window.nutritionNormsLastModel) {
      nutritionNormsDirectRenderSkippedCount += 1;
      nutritionNormsDirectRenderLastResult = { skipped: true, reason: 'no-last-model', rendered: false, scheduled: false, source: eventSource, step: NUTRITION_NORMS_DIRECT_RENDER_COALESCE_STEP };
    ...
    nutritionNormsDirectRenderScheduledCount += 1;
    nutritionNormsDirectRenderPendingSource = eventSource;
    if (nutritionNormsDirectRenderFrameId !== null) {
      nutritionNormsDirectRenderCoalescedCount += 1;
      return { skipped: false, rendered: false, scheduled: true, coalesced: true, source: eventSource, step: NUTRITION_NORMS_DIRECT_RENDER_COALESCE_STEP };
    }
    const schedule = getNutritionNormsDirectRenderRafScheduler();
    nutritionNormsDirectRenderFrameId = schedule(function runCoalescedNutritionNormsDirectRender() {
      const pendingSource = nutritionNormsDirectRenderPendingSource;
      nutritionNormsDirectRenderFrameId = null;
      nutritionNormsDirectRenderPendingSource = null;
      runNutritionNormsDirectRender(pendingSource);
    });
    return { skipped: false, rendered: false, scheduled: true, coalesced: false, source: eventSource, step: NUTRITION_NORMS_DIRECT_RENDER_COALESCE_STEP };
  }

  function getNutritionNormsDirectRenderCoalescingSnapshot() {
    return {
      kind: 'vilda-nutrition-norms-direct-render-coalescing-snapshot',
      step: NUTRITION_NORMS_DIRECT_RENDER_COALESCE_STEP,
      readOnly: true,
      didCallWindowUpdate: false,
      didRenderDom: false,
      scheduler: (typeof window !== 'undefined' && typeof window.requestAnimationFrame === 'function') || typeof requestAnimationFrame === 'function' ? 'requestAnimationFrame' : 'setTimeout',
      coalescedSources: ['vildaResultsModeChanged', 'macroPracticeResourcesReady'],
      pending: nutritionNormsDirectRenderFrameId !== null,
      pendingSource: nutritionNormsDirectRenderPendingSource,
      scheduledCount: nutritionNormsDirectRenderScheduledCount,
      coalescedCount: nutritionNormsDirectRenderCoalescedCount,
      renderRuns: nutritionNormsDirectRenderRenderRuns,
      skippedCount: nutritionNormsDirectRenderSkippedCount,
      lastResult: nutritionNormsDirectRenderLastResult ? Object.assign({}, nutritionNormsDirectRenderLastResult) : null
    };
  }
  ...
  function registerNutritionNormsAfterUpdateHook() {
    ...
    try {
      ...
      if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
        globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { step: NUTRITION_NORMS_AFTER_UPDATE_COALESCE_STEP, helper: 'registerNutritionNormsAfterUpdateHook' });
      }
    }
  ...
  function getNutritionNormsUpdateHookSnapshot(options) {
    ...
    return {
      ...
      afterUpdateCoalescing: getNutritionNormsAfterUpdateCoalescingSnapshot(),
      directRenderCoalescing: getNutritionNormsDirectRenderCoalescingSnapshot(),
      nextStep: '8P-12 — dalsza stabilizacja/wydajność UI bez zmian klinicznych'
    };
  }
  ...
  function initNutritionNormsModule() {
    ...
    try {
      window.addEventListener('vildaResultsModeChanged', function() {
        scheduleNutritionNormsDirectRender('vildaResultsModeChanged');
      });
    } catch (_) {
    if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
      globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { line: 2362 });
    }
  }
    try {
      window.addEventListener('macroPracticeResourcesReady', function() {
        scheduleNutritionNormsDirectRender('macroPracticeResourcesReady');
      });
    ...
    if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
      globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { line: 2372 });
    }
  }
    try {
      renderNutritionNormsCardFromDom();
    ...
    if (typeof globalThis !== 'undefined' && typeof globalThis.vildaLogSwallowedCatch === 'function') {
      globalThis.vildaLogSwallowedCatch('nutrition_norms.js', _, { line: 2377 });
    }
  }
  }
  ...
  window.vildaGetNutritionNormsAfterUpdateCoalescingSnapshot = getNutritionNormsAfterUpdateCoalescingSnapshot;
  window.vildaGetNutritionNormsDirectRenderCoalescingSnapshot = getNutritionNormsDirectRenderCoalescingSnapshot;
  window.VildaNutritionNorms = Object.freeze({
    ...
    getAfterUpdateCoalescingSnapshot: getNutritionNormsAfterUpdateCoalescingSnapshot,
    getDirectRenderCoalescingSnapshot: getNutritionNormsDirectRenderCoalescingSnapshot,
  ...
  if (typeof window !== 'undefined' && typeof window.vildaOnReady === 'function') {
    ...
    if (document.readyState === 'loading') {
      document.addEventListener('DOMContentLoaded', initNutritionNormsModule, { once: true });
    } else {
      initNutritionNormsModule();
    }
  }
})(window, document);
