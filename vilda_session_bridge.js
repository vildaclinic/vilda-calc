...
(function (global) {
  ...
  var AUTH_DEPS = [
    ...
    { type: 'script', src: 'vilda_crypto.js?v=7',     ready: function () { return !!global.VildaCrypto; } },
    { type: 'script', src: 'vilda_vault.js?v=15',     ready: function () { return !!global.VildaVault; } },
    { type: 'script', src: 'vilda_auth_ui.js?v=46',   ready: function () { return !!global.VildaAuthUI; } }
  ];
