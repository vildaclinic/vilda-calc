...
function auditNavigationCoverage() {
  ...
  function showUpdateBanner(onReload, meta) {
    ...
    iosSetTrustedHtml(bar, `
      <span class="ww-sw-update-banner__message" style="display:flex;align-items:center;gap:.5rem;flex:1;min-width:0;">
        <span aria-hidden="true" style="font-size:1.15rem;line-height:1;flex:0 0 auto;">↻</span>
        <span style="min-width:0;"><strong>Pobrano nową wersję</strong> aplikacji.</span>
      </span>
      <div class="ww-sw-update-banner__actions" style="display:flex;gap:.5rem;flex:0 0 auto;">
        <button id="sw-dismiss" type="button" class="btn" style="opacity:.75;background:transparent;" data-vilda-sw-update-action="dismiss" aria-label="Odłóż aktualizację aplikacji na później">Później</button>
